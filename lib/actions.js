...
function highlightLayer2(e) {
    ...
    <div class='tab-pane active' id='Cap' style='padding-bottom: 12px;'>\
        <table class='table table-hover'>\
            ...
            <tr class='active'><td><strong> <a title='Truck space utilization determined by single overnight count' data-toggle='infotooltip'>Truck Spaces Utilized</a>: </strong></td><td> " + props.Activity_1 + " </td></tr>\
        </table>\
    </div></div>\
    <div class='labelfield source'>Data Source: " + props.Source + "</div></div>",
    layerName = 'layer2';
...
function highlightLayer3(e) {
    ...
    <div class='tab-pane active' id='Cap' style='padding-bottom: 12px;'>\
        ...
        <tr class='active'><td><strong>AADT: </strong></td><td>not available</td></tr>\
        </table>\
    </div>\
    <div class='tab-pane' id='Act' style='padding-bottom: 12px;'>\
        <table class='table table-hover'>\
        <tr class='active'><td><strong>Activity Data: </strong></td><td>data entry</td></tr>\
        <tr class='active'><td><strong>Some data: </strong></td><td>not available</td></tr>\
        </table>\
    </div></div>\
    <div class='labelfield source'>Data Source: " + props.Source + "</div></div>",
    layerName = 'layer3';
