...
(function (window, document, undefined) {
    ...
    L.createLegend = function (options) {
        ...
        if(options.legendMarker === 'checkbox'){
            ...
            $('#' + options.layer + '.dyna').wrap('<div class="checkbox" data-toggle="tooltip" title="Click to toggle layer"></div>').after('<label for="' + options.layer + '"><div class="'+ options.legendMarker +' legend-icon '+ options.markerSet +'-icon-'+ options.markerColor +'"><i class="'+options.iconSet+' '+options.iconSet+'-'+options.icon+'"></i></div> '+options.title+'</label>');
        }
